export const nation_name_to_twemoji_flag = (name) => {
    ...
    return {
        ...
        "Austria-Hungary": "https://cdn.jsdelivr.net/gh/twitter/twemoji@v13.0.0/assets/svg/1f1ed-1f1fa.svg",
        "Finland": "https://cdn.jsdelivr.net/gh/twitter/twemoji@v13.0.0/assets/svg/1f1eb-1f1ee.svg",
        "Yugoslavia": "https://cdn.jsdelivr.net/gh/twitter/twemoji@v13.0.0/assets/svg/1f1f7-1f1f8.svg",
...
export const type_name_to_icon = (name) => {
    return {
        ...
        "Aviation Cruiser": "https://raw.githubusercontent.com/NeroYuki/KansenIndex-web/main/backend/data/typeicons/CAV.png",
        "Amphibious Assault Ship": "https://raw.githubusercontent.com/NeroYuki/KansenIndex-web/main/backend/data/typeicons/LHA.png",
        "Coastal Defense Ship": "https://raw.githubusercontent.com/NeroYuki/KansenIndex-web/main/backend/data/typeicons/DE.png",
    }[name] || "https://cdn.jsdelivr.net/gh/twitter/twemoji@v13.0.0/assets/svg/2753.svg"
}
